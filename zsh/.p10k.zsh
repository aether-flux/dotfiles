# Generated by Powerlevel10k configuration wizard on 2025-01-17 at 20:46 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_CURSOR_SHAPE=block
...
function fix_cursor_shape {
  echo -ne '\e[2 q'  # Force block cursor on every prompt
}
autoload -U add-zsh-hook
add-zsh-hook precmd fix_cursor_shape
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$COAL
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$COAL
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$SOFT_BROWN
